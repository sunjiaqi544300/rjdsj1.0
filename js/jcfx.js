(function() {
  ...
  var subAnalysisCharts = echarts.init(
    document.getElementById('subject-analysis')
  );
  ...
  var userDistributionCharts = echarts.init(
    document.getElementById('user-distribution-charts')
  );
  ...
  function refreshAll() {
    ...
    subAnalysisRes = [
      ...
      {name: '数学', value: 130},
      {name: '英语', value: 13},
      {name: '体育', value: 1600, selected: true},
      {name: '劳动', value: 197},
      {name: '生物', value: 165},
      {name: '历史', value: 1520}
    ];
  ...
  function refreshBySubjects(subject = '语文') {
    // top10

 ...
 */
+function ($) {
  let dom = document.querySelector('.fullscreen-menu');
  let fullscreenDom = document.querySelector('body');
  // let bigScreenDom = document.querySelector('.big-screen-btn');
  // if (bigScreenDom) {
  ...
  dom.addEventListener('click', () => {
    let currFullScreenDom = util.getCurrFullscreenDom();
    let fullscreenDom = document.querySelector('body');
    if (currFullScreenDom) {
      util.exitFullScreen(fullscreenDom);
